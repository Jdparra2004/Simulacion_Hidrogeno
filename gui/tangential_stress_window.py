...
class TangentialStressWindow(QMainWindow):
    def __init__(self, main_window):
        ...
        # Conectar directamente al QWidget llamado WTangencial en el archivo .ui
        self.graphWidget = self.WTangencial
    ...
    def RunSimulation(self):
        try:
            ...
            if figuras:
                ...
                fig_tangencial = figuras[1]

                # Mostrar fig_radial en el QWidget de la interfaz
                self.display_graph(fig_tangencial)
            else:
